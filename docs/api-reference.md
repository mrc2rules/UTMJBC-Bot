...
* **[Database & Telemetry](api/database.md)** — Guild configurations, verification metrics, Express dashboard endpoints, and database managers.
* **[Core Utilities & Localization](api/utilities.md)** — Localization strings, wildcard email domain matching, and embeds factories.
